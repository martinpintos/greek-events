export function InsiderNote({ text }: { text: string }) {
  return (
    <div className="relative bg-paper-3 border border-line p-4 md:p-5">
      ...
      <p className="display-h italic text-[17px] md:text-[19px] leading-[1.28] m-0">{text}</p>
      <div className="mt-3 flex items-center gap-2 font-mono text-[10px] tracking-[0.08em] text-mute">
